...
public class ContainsDuplicateSelf {
    public static void main(String[] args) {
        ContainsDuplicateSelf containsDuplicate = new ContainsDuplicateSelf();
        System.out.println(containsDuplicate.solution(new int[]{1, 2, 3, 4, 5}));
        System.out.println(containsDuplicate.solution(new int[]{1, 2, 3, 4, 5, 5}));
    }
